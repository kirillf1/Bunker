...
public partial class GameSessionWithBunker : Migration
{
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        ...
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                game_result_description = table.Column<string>(
    ...
    {
        migrationBuilder.DropTable(name: "bunker_environments");

        migrationBuilder.DropTable(name: "bunker_items");

        migrationBuilder.DropTable(name: "bunker_rooms");

        migrationBuilder.DropTable(name: "catastrophes");

        migrationBuilder.DropTable(name: "game_session_characters");

        migrationBuilder.DropTable(name: "bunkers");
