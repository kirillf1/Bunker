...
[Migration("20250330121002_AddCatastropheComponents")]
partial class AddCatastropheComponents
{
    /// <inheritdoc />
        ...
        modelBuilder.Entity("Bunker.GameComponents.API.Entities.CatastropheComponents.CatastropheEntity", b =>
            {
                ...
                b.HasKey("Id")
                    .HasName("pk_catastrophe_entity");

                b.ToTable("catastrophe_entity", "game_components");
            });
